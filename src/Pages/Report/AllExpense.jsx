...
import { FetchExpenseReport } from "../../redux/actions/authActions";
...
const AllExpense = () => {
  ...
  const { data, loading, error, allCount, totalCash, todayCash } = useSelector(
    (state) => state.auth.Expense
  );
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setIsPageLoad(true);
      try {
        await dispatch(FetchExpenseReport(params));
      } finally {
        setIsPageLoad(false);
      }
    };
  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      const response = await fetch(
        `${base_url}/reports/interest-report-excel-download?${params}`,
        {
          method: "GET",
          headers: {
            Authorization: ` ${token}`,
      ...
      if (response.ok) {
        ...
        link.download = "AllExpenses_List.xlsx";
        link.click();
      } else {
        ...
        <div className="col-xl-12">
          <div className="card custom-card">
            <div className="card-header justify-content-between">
              <div className="card-title">All Expense Report</div>
            </div>
            <div className="card-body">
              ...
              <div className="table-responsive">
                <div className="d-flex justify-content-end">
                  <p className="fs-18">
                    <b>Total Cash Balance:</b> {formatINR(totalCash)}
                  </p>
                  <p className="fs-18 mx-2">|</p>
                  <p className="fs-18">
                    <b>Today’s Transaction:</b> {formatINR(todayCash)}
                  </p>
                </div>
